...
st.markdown(f"""
    ...
    * {{
    ...
    [data-testid="stAppViewContainer"]::before {{
        ...
        background-color: rgba(0, 0, 0, 0.92); z-index: -1;
    }}
    ...
    /* Tento prvek Safari nejčastěji barví na červeno */
    ...
    /* BLACK TERMINAL CARDS - FIX PRO PODSVÍCENÍ GRAFU */
    .jt-card-v16 {{
        background-color: #0c0c0c !important; /* Pevná tmavá barva */
        padding: 25px;
        border-radius: 12px;
...
if not st.session_state.authenticated:
    ...
    st.markdown('<div class="logo-container"><div class="logo-text"><span class="j-green">J</span>T | CAPITAL</div><div style="color:#444; font-size:10px; letter-spacing:3px;">v1.6 TERMINAL</div></div>', unsafe_allow_html=True)
...
with col_c:
    # 1. KARTA S GRAFEM
    st.markdown('<div class="jt-card-v16">', unsafe_allow_html=True)
    components.html("""
    ...
    <div class="jt-card-v16">
        ...
        <div style="border-top: 1px solid #222; margin-top: 20px; padding-top: 10px; color: #444; font-size: 10px; text-align: center;">
            SYSTEM STATUS: ONLINE | SOURCE: AI ENGINE v1.6
        </div>
    </div>
    """, unsafe_allow_html=True)
